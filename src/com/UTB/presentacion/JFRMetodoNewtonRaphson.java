                ...
                switch (this.comboOption.getSelectedIndex()) {
                    case 1:
                        if (!this.txtIteractions.getText().isEmpty()) {
                            ...
                            try {
                                if (!newton.check(funcion, IA)) {
                                    newton.calcNewtonRaphsonByXi(tbResultado, funcion, IA, err, i);
                                } else {
                                    JOptionPane.showMessageDialog(null, "Es posible que el resultado de la derivada sea 0", "Verificación", 1);
                                    clearTable();
                                }
                    ...
                    case 2:
                        if (!this.txtExactRoot.getText().isEmpty()) {
                            ...
                            try {
                                if (!newton.check(funcion, IA)) {
                                    newton.calcNewtonRaphsonByRoot(tbResultado, funcion, IA, err, raiz);
                                } else {
                                    JOptionPane.showMessageDialog(null, "Es posible que el resultado de la derivada sea 0", "Verificación", 1);
                                    clearTable();
                                }
